...
int alsa_playback_init(void)
{
    ...
    /* Two channels (stereo) */
    /* 两个声道 */
    snd_pcm_hw_params_set_channels(playback_handle, params, 1);
	...
	frames_size = playback_frames * 2; /* 2 bytes/sample, 2 channels */
...
int alsa_capture_init(void)
{
	...
	frames_size = capture_frames * 2; /* 2 bytes/sample, 1 channels */
