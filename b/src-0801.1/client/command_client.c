...
void ___send(void)
{
	sendto_node_2(gp_comman_tag[1], gp_comman_tag[2], strlen(gp_comman_tag[2]) + 1, 10);
}
...
void __test(void)
{
	...
	while(1)
	{
		if(sendto_node("qwer", "qwerdf", 7) < 0)
		{
			printf("____!!!! sendto_node qwer err \r\n");
		}else{
			printf("____**** sendto_node qwer ok \r\n");
		}
		if(sendto_node_2("qwer", "qwerdf", 7, 10) < 0)
		{
			printf("____!!!! sendto_node_2 qwer err \r\n");
		}else{
			printf("____**** sendto_node_2 qwer ok \r\n");
		}

		if(sendto_node(gp_comman_tag[1], "qwerdf", 7) < 0)
		{
			printf("____!!!! sendto_node %s err \r\n", gp_comman_tag[1]);
		}else{
			printf("____**** sendto_node %s ok \r\n", gp_comman_tag[1]);
		}
		if(sendto_node_2(gp_comman_tag[1], "qwerdf", 7, 10) < 0)
		{
			printf("____!!!! sendto_node_2 %s err \r\n", gp_comman_tag[1]);
		}else{
			printf("____**** sendto_node_2 %s ok \r\n", gp_comman_tag[1]);
		}
#if 0
